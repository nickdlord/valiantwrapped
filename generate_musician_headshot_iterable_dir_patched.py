...
NEGATIVE_PROMPT = (
    ...
    "crossed eyes, asymmetrical eyes, warped teeth, dull colors, muted colors, flat lighting, plain office portrait, "
    "academic headshot, corporate headshot, passport photo, linkedin photo, hospital portrait, lab coat portrait, "
    "neutral business attire, bland background, realistic office setting, plain wall, ordinary clothing, "
