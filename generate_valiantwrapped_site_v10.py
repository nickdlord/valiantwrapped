    ...
    if author.recommendations:
        ...
        for rec in author.recommendations:
            ...
            items.append(
                ...
                '</div>'
                f'<a class="google-btn" href="{html_escape(rec.google_url)}" target="_blank" rel="noopener noreferrer">Suggested for you</a>'
                '</article>'
            )
        return "\n".join(items)
  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <section id="persona" class="content-card">
        ...
        <p class="section-copy">Generated from the themes, patterns, and publication trail in their real Scopus data — then remixed into full stage-persona mode.</p>
