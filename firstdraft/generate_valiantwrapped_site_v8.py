  ...
  <div class="app-shell">
    ...
    <main class="main-panel">
      ...
      <section id="publications" class="content-card">
        ...
        <h2>2025–2026 Academic Year Stats</h2>
        <p class="section-copy">A good Wrapped looks back before it looks ahead. Consider this the annual academic mirror check.</p>
      ...
      <section id="persona" class="content-card">
        ...
        <div class="persona-grid persona-grid-single">
          <div>
