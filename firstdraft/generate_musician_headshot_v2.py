...
def resolve_persona_input(
    ...
    if has_input_file == has_author_label:
        raise ValueError("Provide exactly one of --input-file or --author-label")
...
def main() -> None:
    ...
    persona_path, author_label = resolve_persona_input(
